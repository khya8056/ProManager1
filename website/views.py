...
def upload_handler(request):
    ...
    if request.method == 'POST':
        ...
        body = sender.first_name + ' ' + sender.last_name + ' Uploaded '+ str(upload_form.file)  + ' check now http://promanager.pythonanywhere.com/home/login'
...
def send(request):
    if not request.user.is_authenticated():
        ...
        if request.method == "POST":
            ...
            body = 'You have a new notification from '+sender.first_name+' '+sender.last_name+' check now http://promanager.pythonanywhere.com/home/login'
